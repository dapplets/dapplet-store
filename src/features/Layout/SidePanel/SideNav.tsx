import React, { useMemo, Dispatch, SetStateAction, useState, useEffect, useCallback } from 'react'
    ...
    <Wrapper>
      <MenuItem>
        <Tooltip
          ...
          tipText={'Add dapplets here for public use and for share it to your followers'}
        >
          <MenuItemLabel
        ...
        {arePendingActions && (
          <PublicListingActionButton disabled={Boolean(isLocked)} onClick={onPush}>
      ...
      <MenuItem>
        <Tooltip isOn={isTrustedUsersListEmpty} tipText={'Add users here to follow them'}>
