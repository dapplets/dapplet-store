...
const FirstLocalDapplet = ({ settings }: FirstLocalDappletProps) => {
  ...
  return (
    <ModalCard>
      ...
      <Title>You’re trying to add {dapplet.title} to the Local Extension List</Title>
      <ModalButtons>
      ...
      <Body>
        <Message>
          Dapplets from this list you will be able to use through the Extension only on this
          computer. In order to use or share the Dapplet on different computers, you need to add the
          Dapplet to the Public List.
        </Message>
        <Controls>
